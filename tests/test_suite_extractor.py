...
class TestExtractorValidInput(unittest.TestCase):
    ...
    def test_single_ipv6(self):
        self.assertEqual(
            self.extractor.check_string(
                value="2001:0db8:85a3:08d3:1319:8a2e:0370:7344"
            ),
            "ip",
    ...
    def test_single_sha1(self):
        self.assertEqual(
            self.extractor.check_string(
                value="94d4d48ba9a79304617f8291982bf69a8ce16fb0"
            ),
            "hash",
    ...
    def test_single_useragent(self):
        self.assertEqual(
            self.extractor.check_string(
                value="Mozilla/5.0 (Windows NT 10.0; WOW64; rv:52.0) Gecko/20100101 "
                "Firefox/52.0"
            ),
            "user-agent",
    ...
    def test_iterable(self):
        ...
        self.assertEqual(l_real, l_expected, "Check_iterable: wrong list returned.")
